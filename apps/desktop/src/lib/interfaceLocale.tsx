...
const english = new Map<string, string>([
  ...
  ["导出 JSON", "Export JSON"],
  ["导出 XML", "Export XML"],
  ["导出 二进制", "Export Binary"],
  ["选择导出格式", "Choose export format"],
  ["导出格式", "Export format"],
  ["运行时 JSON", "Runtime JSON"],
  ["结构数据与多语言资源", "Structure and localized resources"],
  ["类型化结构与多语言资源", "Typed structure and localized resources"],
  ["单文件、带分段完整性校验", "Single file with section integrity checks"],
  ["二进制包", "Binary package"],
  ["新建项目", "New Project"],
  ["打开项目", "Open Project"],
  ["保存项目", "Save Project"],
  ...
  ["新建目录（相对于项目根目录）", "New directory (relative to project root)"],
  ["目录路径", "Directory path"],
  ["创建", "Create"],
  ["取消", "Cancel"],
  ["该目录已经存在。", "This directory already exists."],
  ["空目录", "Empty directory"],
  ["暂无对话目录或匹配的对话", "No dialogue directories or matching dialogues"],
  ...
  ["角色头像", "Character Portrait"],
  [
    "支持 PNG、JPG、JPEG、WebP，图片会复制到项目内，最大 5 MB。",
    "Supports PNG, JPG, JPEG, and WebP. Images are copied into the project, up to 5 MB.",
  ],
  ["选择头像", "Choose Portrait"],
  ["更换头像", "Replace Portrait"],
  ["导入中…", "Importing…"],
  ["移除", "Remove"],
  ["对话", "Dialogue"],
  ["选项", "Choice"],
  ...
  ["导出组织方式", "Export layout"],
  [
    "按一级对话目录拆分后，宿主可以按章节或场景加载。",
    "Split by top-level dialogue directory so hosts can load chapters or scenes on demand.",
  ],
  ["按一级对话目录拆分", "Split by top-level dialogue directory"],
  ["合并为整包", "Bundle all dialogues"],
